...
myApp.config(function ($translateProvider) {
    ...
    $translateProvider.translations('ENG', {
        ...
        lblRulesp1: 'In order to allow all people to get together and play in a pleasant atmosphere, please follow this easy rules:',
        lblRulesp2: '1. No one may be offended or otherwise discriminated in any form because of religion, opinion, belief, appearance, etc.',
        lblRulesp3: '2. In general, a friendly tone is important.',
        lblRulesp4: '3. The instructions of Admins are to be followed.',
        lblRulesp5: '4. If possible, use the channel provided for each game.',
        lblRulesp6: '5. If you are AFK for a longer time (more than 5 minutes), please use the mute or AFK function of TS, so that our Bot can automatically move you into the designated channel for the duration of your abstinence (happens after a few seconds). You will be automatically pushed back when you disable it again.',
        lblRulesp7: 'Should there be any questions, suggestions, criticism or other problems, you can contact our admins, such as Warlord or Felix at any time. The highest ranking admin is tiga05.He has in any case the last word.',
        //lblHint: 'Please be advised, this Page is still under construction!',
        lblHint: '',
        lblWelcome: 'Hello and welcome to our Homepage!',
        lblWhoWeAre: 'Who we are',
        lblWhoWeAreTxtp1: 'We are "Trinkfreunde Heidelberg", a mainly german and english-speaking gaming-community founded in 2013.',
        lblWhoWeAreTxtp2: "We welcome all people who want to play in friendly atmosphere. Our Teamspeak has 512 slots and many different areas, in which you can meet other players from many nations most of the time.",
        lblWhoWeAreTxtp3: "",
